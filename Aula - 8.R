...
hist(residuosAR2, main = "Histograma dos Residuos", col="Pink") #Cria histograma com título e cor cinza
hist(residuosAR2, main = "Histograma dos Residuos", col="Pink", breaks=20) #Cria histograma com título, cor cinza e aumenta número de intervalos para 20
